export const deltaContent = {
  "ops": [
    ...
    },
    {
      ...
      "insert": " for building rich text editors, this package is a thin wrapper around "
    },
    {
      "attributes": {
        "color": "#ff9900",
