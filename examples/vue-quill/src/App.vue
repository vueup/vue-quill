...
<template>
  <main class="app-shell">
    <header class="app-header">
      <div>
        <p class="app-header__label">VueQuill + Vite</p>
        <h1>Comprehensive Vue Quill examples</h1>
        <p>
          A modern Vite app showing editor setup, content binding, toolbar
          strategies, themes, read-only states, events, refs, and form usage.
        </p>
      </div>
